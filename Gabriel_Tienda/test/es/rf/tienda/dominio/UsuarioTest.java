...
public class UsuarioTest {
	...
	public void testSetUser_fecAlta() throws DAOException, DomainException {
		usuario.getUsuarioBase().setUser_fecAlta(StringUtils.stringToCalendar(Constantes.FECHA_OK));
	...
	public void testSetUser_fecConfirmacion() throws DomainException {
		usuario.getUsuarioBase().setUser_fecConfirmacion(StringUtils.stringToCalendar(Constantes.FECHA_OK));
