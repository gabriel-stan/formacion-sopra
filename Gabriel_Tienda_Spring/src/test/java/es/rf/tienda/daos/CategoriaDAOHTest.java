...
//			e.printStackTrace();
	...
	@Test
	public void testGetObject() throws DAOException, DomainException {
	...
	public void testFilter() throws DAOException, DomainException {
		...
		cat4.setCat_nombre(NOMBRE1);
		
		// filtrar todos
		List<CategoriaBase> categorias = catDAO.filter(cat4.getBaseObject());
		...
		categorias = catDAO.filter(cat4.getBaseObject());
		assertEquals(categorias.size(), 3);
