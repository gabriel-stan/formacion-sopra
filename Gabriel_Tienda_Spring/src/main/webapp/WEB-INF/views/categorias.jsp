		...
		<div class="container">
			<div class="breadcrumbs">
				<ol class="breadcrumb">
					...
					<c:if test="${ isAdmin }">
						<li class="pull-right"><a href="categorias/add"><i class="fa fa-plus"></i> Add Category</a></li>				  
					</c:if>
				</ol>
			</div>
								...
								<tr>
									...
									<c:if test="${ isAdmin }">
										<td class="cart_delete">
											<a class="cart_quantity_delete" href="categorias/edit/${ cat.id_categoria }"><i class="fa fa-pencil"></i></a>
